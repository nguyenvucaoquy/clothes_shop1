                    ...
                    <table className="total-line-table">
                      ...
                      <tfoot className="total-line-table-footer">
                        ...
                        <tr className="total-line total-line-gift">
                          <td colSpan={2}>
                            <p>
                              Sau khi "Đặt hàng" thành công, fita sẽ kiểm tra sản phẩm và đóng gói ngay để giao hàng
                              cho bạn. Trong quá trình kiểm tra sản phẩm nếu có phát sinh fita sẽ liên hệ trực tiếp
                              với quý khách để xin xác nhận. fita Xin chân thành cảm ơn!
                            </p>
                          </td>
                        </tr>
                      </tfoot>
                            ...
                            {bankTransfer && (
                              <div className="radio-wrapper content-box-row content-box-row-secondary">
                                <div className="blank-slate">
                                  ...
                                  0918084713 - Chi nhánh Quang Minh * Nội Dung Chuyển Khoản: Online ck + SĐT đặt hàng.
